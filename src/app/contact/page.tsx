...
const contactInfo = [
  { icon: Mail, title: "Email", value: "contact@edwinhub.com", label: "Écrivez-nous" },
                 ...
                 <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid md:grid-cols-2 gap-6">
                       <div className="space-y-2">
                         ...
                         <input 
                            ...
                            className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 px-6 text-white focus:border-[#00FFB2]/50 transition-all focus:outline-none" 
                          />
                       </div>
                       <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <select 
                        ...
                        className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 px-6 text-white focus:border-[#00FFB2]/50 transition-all focus:outline-none appearance-none"
                      >
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea 
                        ...
                        className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 px-6 text-white focus:border-[#00FFB2]/50 transition-all focus:outline-none resize-none"
                      ></textarea>
                    </div>
                    ...
                    <button 
                      ...
                      className="w-full py-5 bg-[#00FFB2] text-black rounded-2xl font-bold text-lg hover:shadow-[0_0_40px_rgba(0,255,178,0.3)] transition-all flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                       {isSubmitting ? 'ENVOI EN COURS...' : 'ENVOYER LE MESSAGE'} <Send className="w-5 h-5" />
                    </button>
                 </form>
              </motion.div>
           </div>
