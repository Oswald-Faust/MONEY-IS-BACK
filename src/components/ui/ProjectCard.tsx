            ...
            <div className="flex items-start justify-between mb-8 gap-4">
              <div className="flex items-center gap-4 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  {project.description && (
                    <p className="text-sm text-dim mt-0.5 line-clamp-1 group-hover:text-gray-300 transition-colors">
                      {project.description}
                    </p>
                  )}
                </div>
              ...
              <div className="relative" ref={menuRef}>
                <button
                  ...
                  className={`
                    ...
                    ${showMenu ? 'bg-white/15 text-white' : 'bg-white/5 text-dim hover:bg-white/10'}
                  `}
                >
                ...
                <AnimatePresence>
                  {showMenu && (
                    <motion.div
                      ...
                      className="absolute right-0 mt-2 w-48 z-50 overflow-hidden rounded-2xl bg-[#1a1a25] border border-white/10 shadow-2xl backdrop-blur-xl"
                    >
                      <div className="p-1.5 space-y-1">
                        <button
                          ...
                          className="w-full flex items-center gap-3 px-3 py-2.5 text-sm font-medium text-gray-300 hover:text-white hover:bg-white/5 rounded-xl transition-all group/item"
                        >
            ...
            <div className="mt-auto">
              ...
              <div className="flex items-center gap-6 text-sm mb-6">
                <div className="flex items-center gap-2 group/stat">
                  <div className="p-1.5 rounded-lg bg-white/5 group-hover/stat:bg-white/10 transition-colors">
                ...
                {project.members && project.members.length > 0 && (
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex flex-col">
                      ...
                      <span className="font-semibold text-white leading-tight">{project.members.length}</span>
                    </div>
                  </div>
                )}
              </div>
              ...
              <div className="relative pt-2">
                <div className="flex items-center justify-between text-xs mb-3">
                  ...
                  <span className="font-black text-white px-2 py-0.5 rounded-md bg-white/5 border border-white/5" style={{ color: project.color }}>
                    {progress}%
                  </span>
                </div>
