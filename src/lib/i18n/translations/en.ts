...
const en: TranslationType = {
  ...
  projectsPage: {
    title: 'My Projects',
    count: 'projects',
    subtitle: 'Track active, paused, and archived projects without losing context.',
    newProject: 'New project',
    ...
    sectionDescriptions: {
      activeProjects: 'Projects that are currently moving and need visibility.',
      pausedProjects: 'Projects to resume later without losing the bigger picture.',
      archivedProjects: 'Closed or shelved projects kept for reference.',
    },
    card: {
  ...
  aiPage: {
    title: 'AI Assistant',
    subtitle: 'A cross-platform AI layer to brainstorm, summarize, organize, and prepare your next actions.',
    newConversation: 'New conversation',
    openFullPage: 'Open AI space',
    floatingTitle: 'Edwin AI',
    floatingSubtitle: 'Always available in your workspace',
    composerPlaceholder: 'Ask a question, request a plan, create a structure...',
    emptyTitle: 'No AI conversations yet',
    emptyDescription: 'Start a discussion to get help with objectives, tasks, or organizing your workspace.',
    quickActionsTitle: 'Suggestions',
    recentConversations: 'Recent conversations',
    noMessages: 'Send your first prompt to start the assistant.',
    generating: 'Edwin AI is thinking...',
    onboardingCardTitle: 'Workspace AI profile',
    onboardingCardDescription: 'The clearer your business context is, the more relevant the assistant will be across the platform.',
    suggestions: {
      projects: 'Give me a quick update on my active projects',
      tasks: 'What are my priorities this week?',
      objectives: 'Propose a priority objective with checkpoints',
      default: 'Help me organize my workspace',
    },
  },
} as const;
