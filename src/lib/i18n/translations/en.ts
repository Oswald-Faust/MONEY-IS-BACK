...
const en: TranslationType = {
  ...
  workspaceMembers: {
    ...
    subtitle: 'Manage your team\'s access and invitations.',
    ...
    removeFromWorkspaceTitle: 'Remove from workspace',
    ...
    toasts: {
      ...
      loadError: 'Error loading members',
  ...
  inviteModal: {
    ...
    successDesc: 'An email was sent to',
    copyLinkDesc: 'You can also copy this invitation link and send it directly:',
    done: 'Done',
    ...
    roles: {
      admin: 'Administrator',
      adminDesc: 'Full workspace access',
      editor: 'Editor',
      editorDesc: 'Can create and edit content',
      visitor: 'Visitor',
      visitorDesc: 'Read-only (comments allowed)',
    },
    sendInvitation: 'Send invitation',
    linkCopied: 'Link copied!',
    projectAccess: 'Project Access',
    selectProjects: 'Using "All projects" or specific selection',
    allProjects: 'All projects',
    oneProjectSelected: '1 selected',
    soManyProjectsSelected: '{count} selected',
    manageProjects: 'Manage projects',
    manageProjectsTitle: 'Manage project access',
    manageProjectsSubtitle: 'Select the projects this member will have access to.',
    updateAccess: 'Update access',
    accessUpdated: 'Access updated successfully',
    projectsAvailable: '{count} project available',
    projectsAvailablePlural: '{count} projects available',
    noProjectSelected: 'Leave empty for workspace-only access (no specific project).',
    toasts: {
  ...
  secureIdsPage: {
    ...
    lockedTitle: 'Secure Zone',
    lockedDesc: 'This section contains sensitive information. Please confirm your identity to continue.',
    passwordLabel: 'Secure Password',
    passwordPlaceholder: 'Your password...',
    unlockButton: 'Unlock Vault',
    verifying: 'Verifying...',
    back: 'Back',
    projectSelectorTitle: 'Secure Project Selector',
    projectSelectorDesc: 'Secure access is isolated by project. Please select a project to access its confidential IDs.',
    accessVault: 'Access Vault',
    noProjectFound: 'No project found',
    createProjectFirst: 'Create a project first to store secure IDs.',
    manageProjects: 'Manage projects',
    confidential: 'Confidential',
    addAccess: 'ADD ACCESS',
    noAccessFound: 'No secure items yet.',
    addFirstAccess: 'Add first access',
    copySuccess: 'Copied!',
    deleteConfirm: 'Are you sure you want to delete this item?',
    projectPasswordTitle: 'Project Password',
    projectPasswordDesc: "Define a specific password for this project. If empty, your account password will be used by default.",
    newPasswordLabel: 'New Password',
    newPasswordPlaceholder: 'New secret...',
    updateButton: 'Update',
    passwordUpdated: 'Project password updated!',
    updateError: 'Error during update',
    connectionError: 'Connection error',
    accessDenied: 'Access denied. You must be a project administrator.',
    ...
    modal: {
      title: 'New Secure Access',
      titleLabel: 'Title (Required)',
      titlePlaceholder: 'Ex: Prod Database Access',
      categoryLabel: 'Category',
      linkLabel: 'Link / URL',
      usernameLabel: 'Username / ID',
      usernamePlaceholder: 'admin@example.com',
      passwordLabel: 'Password / Secret (Required)',
      passwordPlaceholder: 'The secret to protect...',
      notesLabel: 'Notes',
  ...
  ideasPage: {
    title: 'Idea Box',
    titleWithProject: 'Ideas - {projectName}',
    sharedIdeas: 'shared ideas',
    sharedIdea: 'shared idea',
    newIdea: 'New idea',
    searchPlaceholder: 'Search for an idea, a concept...',
    tabs: {
      all: 'All',
      raw: 'Raw',
      standby: 'Standby',
    ...
    empty: 'No ideas found for this filter',
    launchNewIdea: 'Launch a new idea',
    loadError: 'Error loading ideas',
  },

  // --- Objectives Page ---
  objectivesPage: {
    title: 'Global Objectives',
    titleWithProject: 'Objectives - {projectName}',
